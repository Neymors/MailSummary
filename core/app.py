...
@app.route('/obtener_noticias', methods=['POST'])
def obtener_noticias_api():
    """
    Recibe una lista de URLs de feeds RSS en el cuerpo de la petición y devuelve
    la información extraída de cada feed.
    """
